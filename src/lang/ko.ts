export const languageKorean = {
    ...
    "playground": {
        ...
        "inlayImageGallery": "Inlay 이미지 갤러리",
    ...
    "serverBackupHeader": "노드온리 서버 백업",
    "serverBackupDesc": "다운로드 없이 노드온리가 설치된 기기(서버)에 직접 백업 파일을 저장하고 복원합니다.",
    ...
    "togglePresetFilterAll": "전체 보기",
    "togglePresetFilterCurrent": "현재 프롬프트",
    ...
    "importSaveFolderHeader": "노드온리로 세이브 불러오기",
